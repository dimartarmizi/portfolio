        ...
        <section class="rounded-[2rem] border border-white/10 bg-white/5 p-6">
            ...
            <form class="mt-6 grid gap-4 xl:grid-cols-[2fr_1fr_auto]" @submit.prevent="applyFilters">
                ...
                <div>
                    ...
                    <select v-model="filters.employment_type" class="w-full rounded-2xl border border-white/10 bg-slate-950/80 px-4 py-3 text-white outline-none focus:border-amber-400/50 focus:ring-2 focus:ring-amber-400/20">
