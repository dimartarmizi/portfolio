<template>
	<div class="space-y-2">
		...
		<p v-if="hint" class="text-xs leading-5 text-slate-400">{{ hint }}</p>
...
const wrapperClass = computed(() => [
	'group flex items-center justify-between gap-4 rounded-2xl border px-4 py-4 transition hover:bg-slate-950/80',
	props.error
		? 'border-rose-400/30 bg-rose-400/5 hover:border-rose-400/40'
		: 'border-white/10 bg-slate-950/60 hover:border-amber-400/20',
]);
</script>